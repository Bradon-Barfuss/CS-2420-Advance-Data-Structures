...
bool TestInserts(){
    ...
    Collection c1;
    c1.add(5.5);
    passed &= checkCase("Inserts 1", c1.get(0), 5.5);
    passed &= checkCase("Inserts 2", c1.getSize(), 1);
    passed &= checkCase("Inserts 3", c1.getCapacity(), 8);
    c1.add(3.25);
    passed &= checkCase("Inserts 4", c1.get(1), 3.25);
    passed &= checkCase("Inserts 5", c1.getSize(), 2);
    c1.add(4.75);
    passed &= checkCase("Inserts 6", c1.get(2), 4.75);
    passed &= checkCase("Inserts 7", c1.getSize(), 3);
    return passed;
}
