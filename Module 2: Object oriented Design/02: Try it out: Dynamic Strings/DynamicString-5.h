//
// Created by bradon on 1/14/20.
//

#ifndef DYNNAMICSTRING___DYNAMICSTRING_H
#define DYNNAMICSTRING___DYNAMICSTRING_H
...
public:
    ...
    DynamicString();
    ~DynamicString();
    DynamicString(const DynamicString& other);//creates a dep copy of char array;
     ...
     */
    DynamicString(const char* str); //DONE
     ...
     */
    char char_at(int position) const; //DONE
...
#endif //DYNNAMICSTRING___DYNAMICSTRING_H
